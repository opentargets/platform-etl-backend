...
root
 ...
 |    |    |-- biomarker: string (nullable = true)
 |    |    |-- diseases: array (nullable = true)
 |    |    |    |-- element: struct (containsNull = true)
 |    |    |    |    |-- id: string (nullable = true)
 |    |    |    |    |-- label: string (nullable = true)
 |    |    |-- drug: string (nullable = true)
 |    |    |-- drugfamily: string (nullable = true)
 |    |    |-- drugfullname: string (nullable = true)
 |    |    |-- evidencelevel: string (nullable = true)
 |    |    |-- gene: string (nullable = true)
 |    |    |-- individualbiomarker: string (nullable = true)
 ...
 |    |    |-- element: struct (containsNull = true)
 |    |    |    |-- ortholog_species: string (nullable = true)
 |    |    |    |-- ortholog_species_assert_ids: array (nullable = true)
 |    |    |    |    |-- element: string (containsNull = true)
 |    |    |    |-- ortholog_species_chr: string (nullable = true)
 |    |    |    |-- ortholog_species_db_id: string (nullable = true)
 |    |    |    |-- ortholog_species_ensembl_gene: string (nullable = true)
 |    |    |    |-- ortholog_species_entrez_gene: string (nullable = true)
 |    |    |    |-- ortholog_species_name: string (nullable = true)
 |    |    |    |-- ortholog_species_symbol: string (nullable = true)
 |    |    |    |-- support: array (nullable = true)
 |    |    |    |    |-- element: string (containsNull = true)
 |    |-- dog: array (nullable = true)
 |    |    |-- element: struct (containsNull = true)
 |    |    |    |-- ortholog_species: string (nullable = true)
 |    |    |    |-- ortholog_species_assert_ids: array (nullable = true)
 |    |    |    |    |-- element: string (containsNull = true)
 ...
 |    |    |-- id: string (nullable = true)
 |    |    |-- value: struct (nullable = true)
 |    |    |    |-- pathway_name: string (nullable = true)
 |    |    |    |-- pathway_types: array (nullable = true)
 |    |    |    |    |-- element: struct (containsNull = true)
 |    |    |    |    |    |-- pathway_type: string (nullable = true)
 |    |    |    |    |    |-- pathway_type_name: string (nullable = true)
 ...
 |    |    |    |-- unspecified_interaction_effects: array (nullable = true)
 |    |    |    |    |-- element: string (containsNull = true)
