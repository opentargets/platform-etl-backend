...
object LoadersDailymed extends LazyLogging {
...
object Dailymed extends LazyLogging {
  def apply()(implicit context: ETLSessionContext) = {
    ...
    val dailymedSec = context.configuration.dailymed

    import ss.implicits._

//    val targets = LoadersDailymed.loadTargets(commonSec.inputs.target)
//    val diseases = LoadersDailymed.loadDiseases(commonSec.inputs.disease)
//    val drugs = LoadersDailymed.loadDrugs(commonSec.inputs.drug)

    val ctMap = LoadersDailymed.loadDailymed(dailymedSec)
