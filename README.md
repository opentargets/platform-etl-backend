...
10. Homologs
    - Update the release number as required:
        - ftp://ftp.ensembl.org/pub/release-<release>/tsv/ensembl-compara/homologies/homo_sapiens/Compara.<release>.protein_default.homologies.tsv.gz
        - ftp://ftp.ensembl.org/pub/release-<release>/tsv/ensembl-compara/homologies/homo_sapiens/Compara.<release>.ncrna_default.homologies.tsv.gz
        - ftp://ftp.ensembl.org/pub/release-<release>/species_EnsemblVertebrates.txt
    - Files generated by PIS: `104_<species>.tsv` where '104' is the Ensembl Release. This is a file of name and gene
      ids to get the correct name for homology gene ids. There will be one for each species. In the configuration point
      to the *directory* in which they files are present and they will all be read into a single dataframe.
10. Chemical Probes
