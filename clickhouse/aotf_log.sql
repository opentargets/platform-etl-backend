...
-- cat part-00* | jq -r 'del(.unique_association_fields,.facet_therapeuticAreas, .facet_classes, .facet_tractability_antibody, .facet_tractability_smallmolecule,.facet_reactome)|@json' | clickhouse-client -h localhost --query="insert into ot.associations_otf_log format JSONEachRow "
